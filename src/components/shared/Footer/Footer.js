...
import { faMapMarkerAlt, faEnvelope, faCartPlus, faHome,faUserAlt,faFilter} from '@fortawesome/free-solid-svg-icons'
import './Footer.css'
...
const Footer = () => {
    ...
    const home = <FontAwesomeIcon icon={faHome}
        className="home-icon" />
        const category=<FontAwesomeIcon icon={faFilter} className="home-icon"/>
